...
#include "i2c.h"
#define i2c_write(devaddr,regaddr,size,pdata)   HAL_I2C_Mem_Write(&hi2c1, (devaddr<<1), regaddr, I2C_MEMADD_SIZE_8BIT, pdata, size, 100)
#define i2c_read(devaddr,regaddr,size,pdata)   HAL_I2C_Mem_Read(&hi2c1, (devaddr<<1), regaddr, I2C_MEMADD_SIZE_8BIT, pdata, size, 100)
